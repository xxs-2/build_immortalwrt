...
sed -i 's/ImmortalWrt/HiwifiX/g' package/base-files/files/bin/config_generate
...
# Add sirpdboy myautocore
git clone --depth=1 https://github.com/sirpdboy/myautocore
