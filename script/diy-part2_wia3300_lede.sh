...
sed -i 's/ImmortalWrt/WIA3300-10/g' package/base-files/files/bin/config_generate

# 修改开源驱动wifi名称
#sed -i 's/OpenWrt/RAISECOM-MSG1500-$/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh

# 修改闭源驱动2G wifi名称
sed -i 's/OpenWrt/Skspruce-WIA3300-$/g' package/lean/mt/drivers/mt_wifi/files/mt7615.1.2G.dat
sed -i 's/OpenWrt/Skspruce-WIA3300-$/g' package/lean/mt/drivers/mt_wifi/files/mt7615.2G.dat
sed -i 's/OpenWRT-2.4G/WIA3300_2.4G/g' package/lean/mt/drivers/mt7615d/files/lib/wifi/mt_dbdc.sh

# 修改闭源驱动5G wifi名称
sed -i 's/OpenWrt_5G/Skspruce-WIA3300-5G-$/g' package/lean/mt/drivers/mt_wifi/files/mt7615.1.5G.dat
sed -i 's/OpenWrt_5G/Skspruce-WIA3300-5G-$/g' package/lean/mt/drivers/mt_wifi/files/mt7615.5G.dat
sed -i 's/OpenWRT-5G/WIA3300_5G/g' package/lean/mt/drivers/mt7615d/files/lib/wifi/mt_dbdc.sh
